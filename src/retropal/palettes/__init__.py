...
_ADAPTIVE_INFO = (
    PaletteInfo(
        ...
        True,
        platform="Amiga OCS",
        notes="Adaptive conversion palette generated from the source image.",
        generation="16-bit home computer",
        platform_family="Amiga",
        bit_depth="4-bit indexed / 12-bit RGB",
        dac_size=None,
        palette_source="Generated from source image and snapped to Amiga OCS RGB levels",
    ),
    PaletteInfo(
        "amiga-ocs-32",
        "Amiga OCS 32",
        ...
        generation="16-bit home computer",
        platform_family="Amiga",
        bit_depth="5-bit indexed / 12-bit RGB",
        dac_size=None,
        palette_source="Generated from source image and snapped to Amiga OCS RGB levels",
    ),
    PaletteInfo(
        ...
        generation="16-bit home computer",
        platform_family="Amiga",
        bit_depth="6-bit indexed / 12-bit RGB",
        dac_size=None,
        palette_source="Generated from source image and snapped to Amiga ECS RGB levels",
    ),
    PaletteInfo(
        "amiga-aga-256",
        "Amiga AGA 256",
        ...
        platform="Amiga AGA",
        notes="Adaptive conversion palette generated from the source image.",
        generation="32-bit home computer",
        platform_family="Amiga",
        bit_depth="8-bit indexed / 24-bit RGB",
        dac_size="24-bit palette registers",
        palette_source="Generated from source image for Amiga AGA palette registers",
    ),
)
